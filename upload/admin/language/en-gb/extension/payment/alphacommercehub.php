<?php
// Heading
$_['heading_title']					 = 'Alphacommercehub Payments Standard';

// Text
$_['text_extension']				 = 'Extensions';
$_['text_success']					 = 'Success: You have modified PayPal account details!';
$_['text_edit']                      = 'Edit PayPal Payments Standard';
//$_['text_alphacommercehub']				 = '<a target="_BLANK" href="https://www.paypal.com/uk/mrb/pal=V4T754QB63XXL"><img src="view/image/payment/paypal.png" alt="PayPal Website Payment Pro" title="PayPal Website Payment Pro iFrame" style="border: 1px solid #EEEEEE;" /></a>';
